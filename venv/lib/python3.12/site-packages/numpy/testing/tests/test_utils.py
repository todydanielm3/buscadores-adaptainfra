...
class TestBuildErrorMessage:
    ...
    def test_build_err_msg_defaults(self):
        x = np.array([1.00001, 2.00002, 250M03])
        y = np.array([1.00002, 2.00003, 250M04])
        err_msg = 'There is a mismatch'

        a = build_err_msg([x, y], err_msg)
        b = ('\nItems are not equal: There is a mismatch\n ACTUAL: array(['
             '1.00001, 2.00002, 250M03])\n DESIRED: array([1.00002, '
             '2.00003, 250M04])')
        assert_equal(a, b)
    ...
    def test_build_err_msg_custom_precision(self):
        x = np.array([1.000000001, 2.00002, 250M03])
        y = np.array([1.000000002, 2.00003, 250M04])
        err_msg = 'There is a mismatch'

        a = build_err_msg([x, y], err_msg, precision=10)
        b = ('\nItems are not equal: There is a mismatch\n ACTUAL: array(['
             '1.000000001, 2.00002    , 250M03    ])\n DESIRED: array(['
             '1.000000002, 2.00003    , 250M04    ])')
        assert_equal(a, b)
...
class TestAlmostEqual(_GenericTest):
    ...
    def test_error_message(self):
        ...
        x = np.array([1.00000000001, 2.00000000002, 250M03])
        y = np.array([1.00000000002, 2.00000000003, 250M04])
        ...
        expected_msg = ('Mismatched elements: 1 / 3 (33.3%)\n'
                        ...
                        'Max relative difference among violations: '
                        '3.33328889e-06\n'
                        ' ACTUAL: array([1.     , 2.     , 250M03])\n'
                        ' DESIRED: array([1.     , 2.     , 250M04])')
        with pytest.raises(AssertionError, match=re.escape(expected_msg)):
            self._assert_func(x, y)
